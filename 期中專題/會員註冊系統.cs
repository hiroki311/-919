...
namespace 期中專題
{
    public partial class 會員註冊系統 : Form
    {
        ...
        private void btnsend_Click(object sender, EventArgs e)
        {
            ...
            label18.Text = "";
            label20.Text = "";
            dateTimePicker1.Value = 預設時間;
        }
        DateTime 預設時間 = new DateTime(1990, 01, 01);
        ...
        private void textmail_Leave(object sender, EventArgs e)
        {
            ...
            foreach (var s in q)
            {
                ...
                if (IsEmail(textmail.Text) && textmail.Text != s.Email)//正規表達並且輸入的MAIL跟資料庫MAIL不一樣
                {
                    label19.Text = "";
                ...
                if (textmail.Text == s.Email) //
                {
                    label14.Image = imagex;
                    label19.Text = "重複的Email";
                    break;
                }
        ...
        private void button5前往後臺_Click(object sender, EventArgs e)
        {
            星球旅遊後台管理 AA = new 星球旅遊後台管理();
            AA.Show();
        }
    }
